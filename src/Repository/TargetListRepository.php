...
/**
 * @extends ServiceEntityRepository<TargetList>
 *
...
class TargetListRepository extends ServiceEntityRepository
{
    ...
    public function add(TargetList $entity, bool $flush = false): void
    {
    ...
    public function remove(TargetList $entity, bool $flush = false): void
    {
